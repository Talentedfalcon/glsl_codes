...
void main(){
    ...
    st*=10.;
    float n=noise(st)*0.5+0.5;

    float marble=abs(sin(st.x+n*20.));
    color+=mix(vec3(1.),vec3(0.),smoothstep(0.0,0.2,marble));
    color+=mix(vec3(n),vec3(0.),smoothstep(0.2,0.8,marble));
